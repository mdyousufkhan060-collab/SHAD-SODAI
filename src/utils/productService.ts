...
ঠাণ্ডা এবং শুষ্ক স্থানে রাখুন।`,
    ...
    unit: '500g',
    weight: '500g',
    brand: 'SHAD GHOR Premium',
    brand_bn: 'স্বাদ ঘর প্রিমিয়াম',
  ...
  'v1': {
    ...
    unit: '1 kg',
    weight: '1000g',
    brand: 'Shad Ghor Agro',
    brand_bn: 'স্বাদ ঘর এগ্রো',
  ...
  'og1': {
    ...
    unit: '1 Liter Pet',
    weight: '1000ml',
    brand: 'Shad Ghor Organic',
    brand_bn: 'স্বাদ ঘর অর্গানিক',
...
const createDefaultExtension = (id: string, name: string): ProductDetailsExtension => {
  return {
    ...
    description: `Indulge in the finest selected premium organic grocery products from SHAD GHOR. Our products are tested rigorously for chemical safety, purity and unadulterated taste.`,
    description_bn: `স্বাদ ঘরের পক্ষ থেকে সংগৃহীত শতভাগ খাঁটি ও বিশুদ্ধ ${name}। এটি কেমিক্যাল ও ভেজালমুক্ত, যা আপনার সুস্বাস্থ্য বজায় রাখতে সাহায্য করবে।`,
    ...
    faqs: [
      {
        ...
        a: "Yes, all products from SHAD GHOR are collected from verified authentic sources and are fully chemical-free.",
        a_bn: "হ্যাঁ, স্বাদ ঘরের প্রতিটি পণ্য পরীক্ষিত ও যাচাইকৃত উৎস থেকে সংগৃহীত এবং ক্ষতিকারক কেমিক্যালমুক্ত।"
      },
      {
